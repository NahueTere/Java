...
public class EjercicioFruteroDinamico extends JFrame {

    public EjercicioFruteroDinamico() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new EjercicioFruteroDinamico().setVisible(true));
    }
}